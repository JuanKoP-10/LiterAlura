...
import com.aluracursos.literatura.config.ConsumoAPI;
import com.aluracursos.literatura.config.ConvierteDatos;
import com.aluracursos.literatura.model.Autor;
import com.aluracursos.literatura.model.Libro;
import com.aluracursos.literatura.model.LibrosRespuestaApi;
        ...
        while (opcion != 0) {
            ...
            switch (opcion) {
                ...
                case 0:
                    opcion = 0;
                    System.out.println("|********************************|");
                    System.out.println("|    Aplicación Finalizada. Bye! |");
                    System.out.println("|********************************|\n");
                    break;
                default:
                    System.out.println("|*********************|");
...
//        //BUSCAR AUTORES POR ANIO
        ...
        List<Autor> autoresVivos = autorRepository.findByCumpleaniosLessThanOrFechaDeFallecimientoGreaterThanEqual(anioBuscado, anioBuscado);
        ...
        if (autoresVivos.isEmpty()) {
            ...
            for (Autor autor : autoresVivos) {
                if (autor.getCumpleanios() != null && autor.getFechaDeFallecimiento() != null) {
                    if (autor.getCumpleanios() <= anioBuscado && autor.getFechaDeFallecimiento() >= anioBuscado) {
                        if (autoresUnicos.add(autor.getNombre())) {
